...
export const hoanKiemMap = {
  ...
  decorations: [
    ...
    { type: "pocketParking", x: 150, y: 1080, width: 300, height: 112 },
    { type: "pocketParking", x: 654, y: 1120, width: 168, height: 102 },
    { type: "alleyMouth", x: 960, y: 1118, width: 120, text: "NGÕ NHỎ" },
    { type: "alleyMouth", x: 650, y: 586, width: 138, text: "NGÕ PHỐ CỔ" },
    ...
    ...repeatDecor("lamp", [[1220, 420], [1218, 640], [1218, 832], [2148, 430], [2148, 650], [2148, 890], [1510, 1226], [1700, 1226], [1890, 1226], [580, 1336], [1128, 1358], [2480, 1450]]),
    ...repeatDecor("bench", [[1300, 1228], [1450, 1228], [1620, 1228], [1890, 1228], [2060, 1178], [1190, 530], [2134, 534], [2134, 800]]),
    ...repeatDecor("motorbike", [[452, 444], [782, 444], [548, 820], [1032, 924], [190, 1136], [250, 1136], [700, 1170], [2485, 1492]]),
    ...
    ...repeatDecor("planter", [[340, 1220], [760, 1240], [2248, 812], [2570, 820]]),
    ...
    { type: "streetSign", x: 876, y: 604, text: "HÀNG BẠC" },
    { type: "streetSign", x: 1168, y: 1260, text: "LÊ THÁI TỔ" },
    { type: "trafficSign", x: 480, y: 1268, direction: "right" },
    { type: "trafficSign", x: 1084, y: 672, direction: "left" },
    { type: "teaCorner", x: 1010, y: 1200, color: "#2f8ec5" },
    { type: "plasticStools", x: 260, y: 1240 },
    { type: "streetVendor", x: 390, y: 1200, text: "QUÀ VẶT" },
